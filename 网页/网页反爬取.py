...
def getPositionInfo(detail_url):
    ...
    # TODO 使用replace()函数将二进制数据替换成UTF-8编码数字0-2
    ...
    with open("/Users/tongtong/职位数据.txt","a")as f:
