...
for i in range(0, 2):
    ...
    # TODO 将服务器响e应内容转换为字符串形式，赋值给html
    html = response.text
    ...
    for content in content_all:
        ...
        with open(f"{imgName}.jpg", "wb") as f:
            f.write(img)
            # TODO 使用write()将图片写入
##<link rel="stylesheet" type="text/css" href="https://img.dpm.org.cn/Public/static/themes/css/page.css?v=20"><img alt="清乾隆 仿漆釉菊瓣式盖碗" title="清乾隆 仿漆釉菊瓣式盖碗" src="https://img.dpm.org.cn/Uploads/Picture/2021/09/29/s6153d4d062f58.jpg">